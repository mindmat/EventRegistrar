...
DELETE FROM dbo.MailTemplates WHERE Id IN ('A3A7144D-F51F-4B51-ACDD-9FE96F197506', 
										   ...
										   'A4198E42-E965-4259-9154-F673A6F38C4E',
										   '05A0F1D1-7F43-4F30-A29A-9D5E2E38FA66',
										   'D06E51C5-F329-4317-B5FB-2BCEB72D050F',
										   '569FA80F-1BCA-40CC-AA1B-9A68C49FA237',
										   '0A07D8AE-7CD1-4939-A395-14167BD4FAE5',
										   'A07609C7-0715-4892-B0D0-E25F3460DDEC',
										   '698ECAC6-8E95-496C-8531-3BD096B1BFE9');
  ...
  <tbody>
    ...
    <tr>
      <td><br /><strong>Hi&nbsp;{{FirstName}}</strong><br />
        <p>Thank you for registering with Leapin'' Lindy 2018!<br />We have reserved a seat for you, please pay the fee of CHF{{Price}} within the next 5 work days (see details below).</p>
        <p>We are looking forward to welcoming you at Leapin'' Lindy!</p>
        ...
        <table style="width: 826px;">
          <tbody>
            ...
            <tr>
              <td style="width: 130px;"><strong>City</strong></td>
              <td style="width: 700px;">{{City}}</td>
            </tr>
            <tr>
              <td style="width: 130px;"><strong>Phone</strong></td>
              <td style="width: 700px;">{{Phone}}</td>
            </tr>
            <tr>
              <td style="width: 130px;"><strong>Volunteer</strong></td>
              <td style="width: 700px;">{{Volunteer}}</td>
            </tr>
            <tr>
              <td style="width: 130px;"><strong>Reduction</strong></td>
              <td style="width: 700px;">{{Reduction}}</td>
            </tr>
            <tr>
              <td style="width: 130px;"><strong>Comments</strong></td>
              <td style="width: 700px;">{{Comments}}</td>
            </tr>
            <tr>
              <td style="width: 130px;"><strong>Terms</strong></td>
              <td style="width: 700px;">{{AcceptTerms}}</td>
            </tr>
            <tr>
              <td style="width: 130px;"><strong>Price</strong></td>
              <td style="width: 700px;">CHF{{Price}}</td>
            </tr>
          </tbody>
        </table>
    ...
    <tr>
      <td><hr />
        ...
        <p>Please always pay in Swiss Francs. Additional expenses on sender&rsquo;s account.</p>
        ...
        <p>Cancellations until the 10th January 2018:&nbsp;full refund<br />11. January 2018 - 31. Januar 2018: 50%&nbsp;refund<br />February 2018 and later:&nbsp;no refund</p>
        <p>Should you want to cancel your registration, contact us in any case so that we can give your place to someone else.</p>
        <p><strong>IMPORTANT</strong>: Illness and injury are included in the above-mentioned regulations.</p>
        <p>Should you be hindered of participating on a short notice, we will do our best to find a replacement from the waiting list. If we succeed, a refund might be possible. However, we cannot guarantee it. As a principle, the regulations apply.</p>
