...
namespace EventRegistrator.Functions.Registrables
{
    public static class ProcessNewRegistration
    {
        ...
        public static async Task Run([ServiceBusTrigger(ReceivedRegistrationsQueueName, AccessRights.Listen, Connection = "ServiceBusEndpoint")]
         RegistrationRegistered @event,
           TraceWriter log)
        {
