...
public class BulkMailController : Controller
{
    ...
    //public async Task<IEnumerable<BulkMailTemplateItem>> GetMailingTemplatesOfRegistration(string eventAcronym)
    //{
    ...
    //public async Task SaveMailingTemplate(string eventAcronym, [FromBody] MailTemplateItem template,
    //                                      Guid mailTemplateId)
    //{
