...
public class PartnerRegistrationProcessor
{
                                                 ...
                                                 PartnerRegistrationProcessConfiguration config)
    {
        ...
        var (totalFollower, admittedFollower, admittedAndReducedFollower, _, _) = await _priceCalculator.CalculatePrice(followerRegistration, spots);
        ...
        var (total, admitted, admittedAndReduced, _, _) = await _priceCalculator.CalculatePrice(registration, spots);
