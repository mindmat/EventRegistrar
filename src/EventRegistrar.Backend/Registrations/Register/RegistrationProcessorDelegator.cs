            ...
            yield return new PartnerRegistrationProcessConfiguration
                         {
                             ...
                             RoleSpecificMappings = new[]
                                                    {
                                                        // Helfer kurz
                                                        (new Guid("B7ACEA87-ED95-468A-8760-8439FE541496"), Role.Leader,
                                                            new Guid("2303AC02-480D-4EA4-B861-F01DEB7A2A5F")),
                                                        (new Guid("907E3564-E89D-4F7C-9223-EE1BB23013A4"),
                                                            Role.Follower,
                                                            new Guid("2303AC02-480D-4EA4-B861-F01DEB7A2A5F")),
                                                        // Helfer lang
                                                        (new Guid("D23C4941-49EE-48E3-8FBC-5E6BCCE119C8"), Role.Leader,
                                                            new Guid("6BFCCC2A-5C03-42EB-8642-81921701CD48")),
                                                        (new Guid("81291E5A-CB01-4453-8DF1-4F5B88724BA1"),
                                                            Role.Follower,
                                                            new Guid("6BFCCC2A-5C03-42EB-8642-81921701CD48")),
                                                        // T-Shirt Follower
                                                        (new Guid("A3EC7651-293A-40B3-9844-738AEF10D931"),
                                                            Role.Follower,
                                                            new Guid(
                                                                "747C0FE9-1575-4E0B-80CB-DB229D3E00C2")), // Damenmodell Grösse L
                                                        (new Guid("1C257D0D-3808-4A19-B3D5-D2D58A9DAC00"),
                                                            Role.Follower,
                                                            new Guid(
                                                                "AC8D4748-F196-44F6-9807-E1CA1EFE29C7")), // Damenmodell Grösse M
                                                        (new Guid("B5556D7A-8188-4CF9-94F8-364993AEA89E"),
                                                            Role.Follower,
                                                            new Guid(
                                                                "3BAAE211-9B27-47B4-835F-4C9B9052DACF")), // Damenmodell Grösse S
                                                        (new Guid("9BFBDC41-9B8D-43D6-8647-CA496969CB8A"),
                                                            Role.Follower,
                                                            new Guid(
                                                                "0F185525-FF38-4CB7-8B15-0F81ACF0069F")), // Herrenmodell Grösse L
                                                        (new Guid("82C51368-BF74-43C2-80C1-F85D0A996359"),
                                                            Role.Follower,
                                                            new Guid(
                                                                "2148016C-BB24-4055-B5C2-14F0E2333ABA")), // Herrenmodell Grösse M
                                                        (new Guid("C21720AF-94A9-4B45-917D-306934F00868"),
                                                            Role.Follower,
                                                            new Guid(
                                                                "F9F46BE4-4E57-4748-897A-3708D312A8EC")) // Herrenmodell Grösse S
                                                    }
                             //LanguageMappings = new[]
                             //{
                             //    (new Guid("46AD095F-A014-4321-BC5F-5C98F9060F1D"), Language.Deutsch ),
