...
public class BookingsByStateQueryHandler(IQueryable<IncomingPayment> incomingBookings,
                                         IQueryable<OutgoingPayment> outgoingBookings)
    : IRequestHandler<BookingsByStateQuery, IEnumerable<PaymentDisplayItem>>
{
