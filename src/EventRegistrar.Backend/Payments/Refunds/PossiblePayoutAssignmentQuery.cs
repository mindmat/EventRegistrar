...
public class PossiblePayoutAssignmentQueryHandler(IQueryable<OutgoingPayment> payments,
                                                  IQueryable<PayoutRequest> payoutRequests)
    : IRequestHandler<PossiblePayoutAssignmentQuery, IEnumerable<PossiblePayoutAssignment>>
{
    public async Task<IEnumerable<PossiblePayoutAssignment>> Handle(PossiblePayoutAssignmentQuery query,
                                                                    CancellationToken cancellationToken)
    {
        var payment = await payments.Where(pmt => pmt.Id == query.PaymentId
