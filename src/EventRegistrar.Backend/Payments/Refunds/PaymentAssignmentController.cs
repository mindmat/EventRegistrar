...
namespace EventRegistrar.Backend.Payments.Refunds
{
    public class PayoutAssignmentController : Controller
    {
        ...
        public async Task AssignPayment(string eventAcronym, Guid paymentId, Guid payoutRequestId, decimal amount, bool acceptDifference, string acceptDifferenceReason)
        {
