...
//    public PaymentAssignedUserTranslation(IQueryable<Payment> payments,
...
//            return
//                $"Rückzahlung über {domainEvent.Amount} an {paymentCounter?.CreditorName} zu Zahlung über {payment?.Amount} von {payment?.DebitorName} zugeordnet (Anmeldung {registration?.RespondentFirstName} {registration?.RespondentLastName})";
//        }
