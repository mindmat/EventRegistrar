...
namespace EventRegistrar.Backend.Migrations
{
    ...
    [Migration("20260213152130_AddMenuNodeToolTipData")]
    partial class AddMenuNodeToolTipData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Infrastructure.AuditLog.RequestLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("UserDisplayText")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.HasIndex("EventId", "RequestType");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Infrastructure.MenuNodes.MenuNodeReadModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ToolTipData")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("ToolTipDataType")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Infrastructure.ReadableIds.ReadableIdSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EventId", "Prefix")
                        .IsUnique()
                        .HasFilter("[Prefix] IS NOT NULL");

                    b.ToTable("ReadableIdSources", (string)null);
                });
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Mailing.Mail", b =>
                {
                    ...
                    b.Property<string>("MailSenderMessageId")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("MailSenderMessageId");
                    ...
                    b.HasIndex("EventId", "Sent");

                    b.ToTable("Mails", (string)null);
                });

            modelBuilder.Entity("EventRegistrar.Backend.Mailing.MailAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Mailing.Templates.AutoMailTemplate", b =>
                {
                    ...
                    b.Property<string>("FailedPlaceholderChecks")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("FailedPlaceholderChecksJson");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Payments.Files.IncomingPayment", b =>
                {
                    ...
                    b.Property<string>("DebitorAdressLine")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("DebitorBuildingNr")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("DebitorCountry")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<string>("DebitorStreet")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("DebitorTown")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("DebitorZip")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Registrables.Pricing.PricePackagePart", b =>
                {
                    ...
                    b.Property<bool>("ShowInMailSpotList")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Registrables.Registrable", b =>
                {
                    ...
                    b.Property<bool>("IsReusableInPricePackages")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.RegistrationForms.Questions.Question", b =>
                {
                    ...
                    b.Property<Guid?>("QuestionId_Partner")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Registrations.Raw.RawRegistration", b =>
                {
                    ...
                    b.Property<bool>("RoleMissing")
                        .HasColumnType("bit");

                    b.Property<int?>("RoleOverride")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Registrations.Registration", b =>
                {
                    ...
                    b.Property<string>("PricePackageIds_ManualFallback")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Registrations.Remarks.RegistrationRemark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RegistrationRemarks", (string)null);
                });
            ...
            modelBuilder.Entity("EventRegistrar.Backend.Statistics.StatisticSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Key", "EventId", "CreatedAt");

                    b.ToTable("StatisticSnapshots", (string)null);
                });

            modelBuilder.Entity("EventRegistrar.Backend.VolunteerPlanning.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RegistrableId_ShiftPreference")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("RegistrationId_Responsible")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RegistrableId_ShiftPreference");

                    b.HasIndex("RegistrationId_Responsible");
            ...
            modelBuilder.Entity("EventRegistrar.Backend.VolunteerPlanning.ShiftAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShiftId", "RegistrationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("EventRegistrar.Backend.VolunteerPlanning.Shift", b =>
                {
                    ...
                    b.HasOne("EventRegistrar.Backend.Registrables.Registrable", "Registrable_ShiftPreference")
                        .WithMany()
                        .HasForeignKey("RegistrableId_ShiftPreference")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EventRegistrar.Backend.Registrations.Registration", "Registration_Responsible")
                        .WithMany()
                        .HasForeignKey("RegistrationId_Responsible")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Event");

                    b.Navigation("Registrable_ShiftPreference");

                    b.Navigation("Registration_Responsible");
                });
            ...
            modelBuilder.Entity("EventRegistrar.Backend.VolunteerPlanning.ShiftAssignment", b =>
                {
                    ...
                    b.HasOne("EventRegistrar.Backend.VolunteerPlanning.Shift", "Shift")
                        .WithMany("Assignments")
